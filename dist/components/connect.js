...
exports.default = function (paths, mapStateToProps) {
  var mapUpdateToProps = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (dispatch, $updateGraph) {
    return { dispatch: dispatch, $updateGraph: $updateGraph };
  };
    ...
    var FalcorConnect = function (_Component) {
      ...
      _createClass(FalcorConnect, [{
        ...
        value: function render() {
          return _react2.default.createElement(WrappedComponent, Object.assign({}, this.props, mapUpdateToProps(this.context.store.dispatch, this.context.updateGraph()), {
